...
int main(int argc, char *argv[]) {
	...
	printf("|       Go          |        PP         |     Music Class  |        HW       |    Swimming     |                  |                |              |                 |       Lunch           |10-0:00|MT,ST,Sleep|\n");
	printf("|       PP          |         D         |      Dinner      |         D       |     Dinner      |                  |                |              |                 |         C++           |_______|___________|\n");
	printf("|      Dinner       |       Study       |        HW        |        FT       |       MT        |                  |                |              |                 |      PP (Full)        |                   |\n");
	printf("|        D          |      Dinner       |         D        |      Dinner     |       HW        |                  |                |              |                 |        Bash           |                   |\n");
	printf("|        C          |      Sleep        |      Sleep       |      Sleep      |      Sleep      |                  |                |              |                 |    Music Class        |                   |\n");
	printf("|      Sleep        |                   |                  |                 |                 |                  |                |              |                 |     Dinner            |                   |\n");
	printf("|                   |                   |                  |                 |                 |                  |                |              |                 |         Sleep         |                   |\n");
	...
	printf("|6:10|    PA        |6:20| Python/Bash  |6:05|    Study    |6:15| Breakfast  |6:10| C/C++/Java |                 |                |              |                 |6:40| C++/Java/C/Bash  |OP  Go/JS/Bash     |6:30PM|   FT         |\n");
	printf("|6:45|    HW        |7:00|     D        |7:00|    PA       |6:05|   Study    |6:40| Breakfast  |                 |                |              |                 |7:40|     PA           | I      %s         |9:20|     Sleep      |\n", fail2list1);
	printf("|7:20|  Breakfast   |7:25|  Breakfast   |7:35|  Breakfast  |9:00|    PP      |7:12|  School    |                 |                |              |                 |8:20|      D           | I      %s         |____|________________|\n", fail2list5);
	printf("|7:35|   Python     |8:00|   School     |8:00|   School    |10:00|   PA      |4:10|  Lunch     |                 |                |              |                 |9:00|  Breakfast       |OP    Python       |                     |\n");
	printf("|8:00|   School     |3:40|   Lunch      |3:40|   Lunch     |10:45| Program   |4:40|    HW      |                 |                |              |                 |9:30| MT (Sun. + Thu.) | I      %s         |                     |\n", fail2list6);
	printf("|3:40|    Lunch     |4:20|     HW       |4:10|    PP       |12:15|    FT     |5:30|    PP      |                 |                |              |                 |10:00|  Python/JS/Go   | I      %s         |                     |\n", fail2list2);
	printf("|4:10|     PP       |5:10|     PP       |5:20|    PA       |1:40|    Lunch   |6:00|    PA      |                 |      TENNIS    |   SWIMMING   |TENNIS & SWIMMING|10:30|     PA          |OP  Java/C/C++     |                     |\n");
	printf("|5:30|     PA       |6:30|     PA       |6:00| Music Class |2:40|     D      |6:30|   Study    | TENNIS + SCHOOL |                |              |                 |11:10|     HW          |                   |                     |\n");
	printf("|6:00|      D       |7:10|     MT       |8:00|  Dinner     |3:20|    HW      |7:00| Swimming   |                 |                |              |                 |1:40|    Lunch         |    Dinner/Sleep   |                     |\n");
	printf("|6:40|     HW       |7:45|   Dinner     |8:30|    HW       |6:00|    FT      |8:40|  Dinner    |                 |                |              |                 |2:40|      FT          |                   |                     |\n");
	printf("|7:30|   Dinner     |8:20|   Study      |9:00|    MT       |7:50|   Dinner   |9:10|     D      |                 |                |              |                 |3:00|   PP (Full)      |                   |                     |\n");
	printf("|8:00|     Go       |9:00|   Sleep      |9:30|   Sleep     |8:30|    MT      |9:25|    MT      |                 |                |              |                 |5:40|  FT, Music Class | * Stop following  |                     |\n");
	printf("|8:20|      C       |____|______________|____|_____________|9:00|   Sleep    |9:40|  Sleep     |                 |                |              |                 |8:30|  Dinner + Sleep  | if past 11:00PM   |                     |\n");
	printf("|9:00|   Sleep      |                                      |    |            |    |            |                 |                |              |                 |                       |                   |                     |\n");
	printf("|____|______________|                                      |    |            |    |            |                 |                |              |                 |_______________________|___________________|_____________________|\n");
