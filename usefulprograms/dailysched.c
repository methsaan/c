...
int main(int argc, char *argv[]) {
	...
	printf("%s %s %s %s %s %s", fail2list1, fail2list2, fail2list3, fail2list4, fail2list5, fail2list6);
	...
	printf("|5:40|   C/C++      |5:40|     PA       |5:40|     D       |5:40|     D       |5:40| Python/JS |5:10|    PA      |5:10|    PA      |                         |        %s          |\n", fail2list4);
	printf("|6:15|    PA        |6:20|    Study     |6:10|    Study    |6:20|   Study     |6:40|    D      |5:40| Breakfast  |5:40| Breakfast  |                         |OP  Go/JS/Bash      |\n");
	printf("|6:45|  Study       |6:40|     D        |6:30|    PA       |6:50|    FT       |7:30|   MT      |6:05| OA/PP/PR   |6:05|  OA/C/C++  |                         |        %s          |\n", fail2list1);
	printf("|7:00| Breakfast    |7:00|  Breakfast   |7:00|  Breakfast  |7:30| Breakfast   |8:10| Breakfast |9:00|    MT      |9:00|OA/Swim/Bash|                         |        %s          |\n", fail2list5);
	printf("|7:15|   School     |7:15|   School     |7:12|School/Study |8:00|    FT       |8:40|    PP     |10:00|  Python   |11:00|   PA      |                         |OP    Python        |\n");
	printf("|4:00|   Lunch      |4:00|   Lunch      |4:00|   Lunch     |8:30|  Exercise   |10:00| Java/Go  |10:45|   PA      |11:40|  Lunch    |                         |        %s          |\n", fail2list6);
	printf("|4:30|     HW       |4:30|     HW       |4:35|    PP       |12:15|   FT       |10:50|   PA     |11:15|  JS/C++   |12:40|    D      |                         |        %s          |\n", fail2list2);
	printf("|5:30|     PP       |5:15|     PP       |5:35|    PA       |12:30|  Lunch     |11:30| Lunch    |11:40|  Lunch    |1:45|  Tennis    |                         |OP  Java/C/C++      |\n");
	printf("|6:30|     PA       |6:30|     PA       |6:05|    HW       |1:00| Programming |12:30| Python/JS|12:30|   PP      |2:40| JS/Python  |                         |                    |\n");
	printf("|7:10|     MT       |7:15|     MT       |6:30| Music Class |6:00|  Guitar     |2:30|  C/C++    |1:20|     D      |3:40|  Bash      |                         |    Dinner/Sleep    |\n");
	printf("|7:40|   Python     |7:45|   Dinner     |8:30|    MT       |7:30|    PP       |4:30|   Bash    |1:50|    FT      |4:40| Go/Java    |                         |                    |\n");
	printf("|8:10|     D        |8:40|   Sleep      |8:50|  Dinner     |2:50|#############|5:30|    FT     |2:50|    JS      |5:40|   PP       |                         |                    |\n");
