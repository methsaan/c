...
int main(int argc, char *argv){
	...
	printf("|__SCHOOL/LUNCH___|__SCHOOL/LUNCH_|_____SCHOOL______|______PYTHON______|_____FT_+ BANANA___|_____LUNCH/Java_____|_________C++_______|________JS/C_______|\n");
	...
	printf("|_____PYTHON______|_____R1________|______Bash_______|____HW_+_PA_______|_________D_________|_________Go_________|_________PP________|_______Lunch_______|\n");
	...
	printf("|____FT_+_BANANA__|______MT_______|_______D_________|__________________|________R4_________|____________________|___________B_______|_______R3/R2_______|\n");
	...
	printf("|7:12___SCHOOL____|3:55___Shower____|4:35____Lunch____|4:45____PP________|8:40__PP/MT/D/Go__|8:15___Swimming___|1:00______PP_______|1:00______MT________|\n");
