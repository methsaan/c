...
int main(int argc, char *argv[]) {
	...
	printf("|            REGULAR SCHEDULE            Wake up 5:10 AM           Sleep 8:40-9:30 PM             Workout:  Push ups: 3 sets of 18, Squats: 3 sets of 30, Plank: 1:25 min                   |          FAIL1  (timed)       |\n");
	...
	printf("|6:45|    HW        |7:00|     D        |7:00|    PA       |6:50|   Study    |7:30| Breakfast  |                 |                |              |                 |7:40|     PA           |    MT + Study     |9:20  |   Sleep      |\n");
	printf("|7:20|  Breakfast   |7:25|  Breakfast   |7:35|  Breakfast  |7:40|    PP      |8:00|  School    |                 |                |              |                 |8:20|      D           |     PA + D        |      |              |\n");
	printf("|7:35|   Python     |8:00|   School     |8:00|   School    |9:00|    PA      |4:10|  Lunch     |                 |                |              |                 |9:00|  Breakfast       |___________________|      |              |\n");
	printf("|8:00|   School     |3:40|   Lunch      |3:40|   Lunch     |9:50|  Program   |4:40|    HW      |                 |                |              |                 |9:30| MT (Sun. + Thu.) |  D + (PA/PA #2)   |      |              |\n");
	printf("|3:40|    Lunch     |4:20|     HW       |4:10|    PP       |12:00|    FT     |5:30|    PP      |                 |                |              |                 |10:00|  Python/JS/Go   |     MT + PP       |      |              |\n");
	printf("|4:10|     PP       |5:10|     PP       |5:20|    PA       |1:40|    Lunch   |6:00|    PA      |                 |      TENNIS    |   SWIMMING   |TENNIS & SWIMMING|10:30|     PA          |_______Lunch_______|      |              |\n");
	printf("|5:30|     PA       |6:30|     PA       |6:00| Music Class |2:30|     D      |6:30|   Study    | TENNIS + SCHOOL |                |              |                 |11:10|     HW          |     D + MT        |      |              |\n");
	printf("|6:00|      D       |7:10|     MT       |8:00|  Dinner     |3:20|    HW      |7:00| Swimming   |                 |                |              |                 |1:40|    Lunch         | (PA/PA #2/FT)+PP  |      |              |\n");
	printf("|6:30|     HW       |7:45|   Dinner     |8:30|    HW       |6:00|    FT      |8:40|  Dinner    |                 |                |              |                 |2:40|      FT          |___________________|      |              |\n");
	printf("|7:10|   Dinner     |8:20|   Study      |9:00|    MT       |7:50|   Dinner   |9:10|     D      |                 |                |              |                 |3:00|   PP (Full)      |    PP + D + MT    |      |              |\n");
	printf("|7:50|     MT       |9:00|   Sleep      |9:30|   Sleep     |8:30|    MT      |9:25|    MT      |                 |                |              |                 |5:40|  FT, Music Class |     Study + D     |      |              |\n");
