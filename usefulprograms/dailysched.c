...
int main(int argc, char *argv){
	...
	char *timea = __TIME__;
	if ((timea[0] == '0') && ((timea[1] == '4') || (timea[1] == '5') || (timea[1] == '6'))) {
	...
	printf("|_6:30_|Homework |_6:10_|Homewo.|_6:00_|   D    |_6:00_|Homewo.|_6:40_|Progr.|_2:20_|C/Python|_3:30_|    D   |_1:10_|  Python  |______________|\n");
	...
	printf("|_8:15_|   FT    |_7:50_|  ft   |_7:00_|   PP   |_7:50_| Dinner|_8:05_|  FT  |_4:00_| Program|_5:00_|  Bash  |_4:00_|     D    |______________|\n");
	...
	printf("|______|_________|______|_______|______|________|______|_______|______|______|_7:40_|   FT   |_7:00_|   FT   |_7:40_|  Program |______________|\n");
	printf("|______|_________|______|_______|______|________|______|_______|______|______|_8:00_| sleep  |_7:30_|__sleep_|_8:00_|  Dinner  |______________|\n");
