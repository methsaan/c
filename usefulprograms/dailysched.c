...
int main(int argc, char *argv[]) {
	...
	printf("|        MT         |        MT         |        MT        |        FT        |       FT       |        C++      |       D         |                |      D       |                 |          PA           |11-12:00|  Lunch   |\n");
	...
	printf("|      Study        |        PA         |        PP        |      Guitar      |     Dinner     |        HW       |    Swimming     |                |    Bash      |                 |       Lunch           |10-0:00|MT,ST,Sleep|\n");
	printf("|        D          |         D         |     Music Class  |       PP         |      Study     |         D       |     Dinner      |                |     PA       |                 |         C++           |_______|___________|\n");
	...
	printf("|6:45|  Study       |6:40|     D        |6:30|    PA       |6:50|    FT       |8:00|   FT      |6:05|    PP      |6:40| Breakfast  |                |7:00|   B     |                 |7:40|     PA           |        %s         |\n", fail2list1);
	printf("|7:00| Breakfast    |7:00|  Breakfast   |7:00|  Breakfast  |7:30| Breakfast   |8:30| Exercise  |9:00|   Study    |7:12|  School    |                |8:00|   D     |                 |8:20|      D           |        %s         |\n", fail2list5);
	printf("|7:15|   School     |7:15|   School     |7:12|School/Study |8:00|    FT       |12:15|   FT     |10:00|   PA      |4:10|  Lunch     |                |8:40| Study   |                 |9:00|  Breakfast       |OP    Python       |\n");
	printf("|4:00|   Lunch      |4:00|   Lunch      |4:00|   Lunch     |8:30|  Exercise   |12:30|  Lunch   |10:45| Program   |4:40|    HW      |                |9:30|  MT     |                 |9:30| MT (Sun. + Thu.) |        %s         |\n", fail2list6);
	printf("|4:30|     HW       |4:30|     HW       |4:35|    PP       |12:15|   FT       |1:00|  Computer |12:15|    FT     |5:30|    PP      |                |10:10|  PP    |                 |10:00|  Python/JS/Go   |        %s         |\n", fail2list2);
	printf("|5:30|     PP       |5:15|     PP       |5:35|    PA       |12:30|  Lunch     |7:30|    PP     |1:40|    Lunch   |6:00|    PA      |      TENNIS    |11:00| Python |TENNIS & SWIMMING|10:30|     PA          |OP  Java/C/C++     |\n");
	printf("|6:30|     PA       |6:30|     PA       |6:00| Music Class |1:00| Programming |8:30|  Dinner   |2:40|     D      |6:30|   Study    |                |12:40| Lunch  |                 |11:10|     HW          |                   |\n");
	printf("|7:10|     MT       |7:15|     MT       |8:00|    HW       |6:00|  Guitar     |9:00|   Study   |3:20|    HW      |7:00| Swimming   |                |1:40|  Java   |                 |1:40|    Lunch         |    Dinner/Sleep   |\n");
	printf("|7:40|   Python     |7:45|   Dinner     |8:30|    MT       |7:30|    PP       |9:30|    MT     |6:00|    FT      |8:40|  Dinner    |                |2:40|   PA    |                 |2:40|      FT          |                   |\n");
	printf("|8:10|     D        |8:40|   Sleep      |8:50|  Dinner     |8:30|   Dinner    |10:00|     D    |7:50|   Dinner   |9:10|     D      |                |3:40|   C     |                 |3:00|      PP          |                   |\n");
	printf("|8:40|   Dinner     |    |              |9:30|   Sleep     |9:10|   Sleep     |10:25|  Sleep   |8:30|    MT      |9:25|    MT      |                |4:40|   HW    |                 |5:40|  FT, Music Class |                   |\n");
	printf("|9:10|   Sleep      |____|______________|____|_____________|____|_____________|____|___________|9:00|   Sleep    |9:40|  Sleep     |                |7:40|  Dinner |                 |8:30|  Dinner + Sleep  |                   |\n");
	printf("|____|______________|                                                                          |    |            |    |            |                |8:20|  Sleep  |                 |                       |                   |\n");
	printf("Codes:                                                                                         |    |            |    |            |                |              |                 |_______________________|___________________|\n");
	printf("                                                                                               |    |            |____|____________|________________|______________|_________________|\n");
