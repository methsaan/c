...
int main(int argc, char *argv[]) {
	...
	fscanf(fp2, "%s", str5);
	fscanf(fp2, "%s", str6);
	strcpy(str1, fail2list[0]);
	strcpy(str2, fail2list[1]);
	strcpy(str3, fail2list[2]);
	strcpy(str4, fail2list[3]);
	strcpy(str5, fail2list[4]);
	strcpy(str6, fail2list[5]);
	printf("fdfdsdfdesdfd\n\n");
