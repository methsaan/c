...
int main(int argc, char *argv){
	...
	if ((timea[0] == '0') && (timea[1] == '5')) {
		...
		char *studytypes[11] = {s, "Math", "Science", "History", "Geography", "Geography", "French", "History", "English", "Sinhala", "Programming"};
		fprintf(fpw, "%s\n", studytypes[rand()%11]);
		fclose(fpw);
	}	
	...
	printf("|_______PA________|____Study______|_____JAVA/GO_____|_______PP_________|_____C++/Java/c____|_____SWIMMING_______|______Tennis/ft____|______Tennis/ft____|\n");
