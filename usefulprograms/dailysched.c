...
int main(int argc, char *argv[]) {
	...
	printf("|        MT         |        PA         |        MT        |      C, C++      |  Java/Python   |     OA/C++      |    OA/Swimming  |       C       |   Swimming/OA   |11-12:00|  Lunch   |\n");
	printf("|       Bash        |       Java        |         C        |       Go         |    JS + MT     |      Study      |    Java/JS      |    MT + OA    |     C/JS        |12-1:00|    C      |\n");
	printf("|    Breakfast      |     Breakfast     |    Breakfast     |     Tennis       |       D        |       Java      |     FT / D      |       FT      |       D         |1-4:00| PP/FT      |\n");
	printf("|     School        |      School       |      School      |      Lunch       |    Lunch       |        PA       |       PA        |       ST      |      PP         |4-5:30| PA         |\n");
	printf("|      Lunch        |       Lunch       |      Lunch       |     Swimming     |     Study      |        PP       |       PP        |       MT      |      Lunch      |______|____________|\n");
	printf("|       HW          |   Study + HW      |        HW        |         D        |      FT        |      Lunch      |     Lunch       |     Lunch     |    Tennis       |                   |\n");
	printf("|       PP          |        PP         |        PA        | (HW/MT) / (HW+MT)|    HW/PP       |        MT       |     Tennis      |      Bash     |      FT         |                   |\n");
	printf("|     Study + D     |        JS         |        PP        |        PA        |     PP/FT      |         D       |       ST        |       D       |      PA         |                   |\n");
	printf("|       PA          |        PA         |     Music Class  |        PP        |      PA        |      Python     |       MT        |      PA       |      ST         |                   |\n");
	printf("|       FT          |      FT + D       |        FT        |       Study      |      Java      |        FT       |      Bash       |      PP       |      C++        |                   |\n");
	...
	printf("|6:20|  Study       |6:30|     D        |6:05|    PA       |6:05|  Program    |6:10|   ST      |6:05| OA/PP/PR   |6:05|  OA/C/C++  |6:05|  OA/Java  |6:05|  OA/Python |                    |\n");
	printf("|6:50| Breakfast    |6:50|  Breakfast   |6:35|    MT       |9:20|    Study    |8:00|   JS      |9:00|    MT      |9:00|OA/Swim/Bash|9:30|    MT     |9:00|OA/Swim/Bash|                    |\n");
	printf("|7:10|   School     |7:12|   School     |6:50|  Breakfast  |9:50|   Java      |10:00|   PA     |10:00|  Python   |11:00|   PA      |10:00|   PP     |11:00|   ST      |                    |\n");
	printf("|4:00|   Lunch      |4:20|     PA       |7:12|   School    |10:30|  Tennis    |11:30|  Lunch   |10:45|   PA      |11:40|  Lunch    |11:00|   C      |11:40|  Lunch    |                    |\n");
	printf("|4:30|     HW       |4:50|   Lunch      |4:20|  HW+Lunch   |2:20|    Lunch    |12:30|   MT     |11:15|  JS/C++   |12:40|    D      |11:40| Lunch    |12:40|    D      |                    |\n");
	printf("|5:00|     PP       |5:25|     HW       |4:50|    PP       |3:30| Swimming    |1:00|  Java/C++ |11:40|  Lunch    |1:45|  Tennis    |12:40|   ST     |1:45|  Tennis    |                    |\n");
	printf("|6:00|     PA       |6:15|     PP       |5:25|    PA       |5:00|   Study     |2:30|Py./Bash/Go|12:30|   PP      |2:40| JS/Python  |1:40|  Python   |2:40|    JS      |                    |\n");
	printf("|6:40|     MT       |7:15|     PA       |5:55|     D       |5:40|   Java      |5:20|   D       |1:20|     D      |3:40|  Bash      |2:40|    PA     |3:40|    FT      |                    |\n");
	printf("|7:20|   Python     |7:45|     MT       |6:10| Music Class |6:20|    PA       |6:00|   PP      |1:50|    FT      |4:40| Go/Java    |3:10|    C      |4:40|  Program   |                    |\n");
