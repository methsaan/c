...
int main(int argc, char *argv[]) {
	...
	fscanf(fp2, "%s", str5);
	fscanf(fp2, "%s", str6);
	strcpy(fail2list[0], str1);
	strcpy(fail2list[1], str2);
	strcpy(fail2list[2], str3);
	strcpy(fail2list[3], str4);
	strcpy(fail2list[4], str5);
	strcpy(fail2list[5], str6);
	printf("%s", fail2list[3]);
