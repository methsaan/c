...
int main(int argv, char *argc){
	...
	printf("                                                             |  PP        | PP        |       PA        |\n");
	printf("                      Sinhala dictation 5:30pm               |  PBT       | D         |       PP        |\n");
	printf("                        PA = physical activity               |  FT        | FT        |       Read      |\n");
	printf("                        PT = piano theory                    |            |           |       PT        |\n");
	printf("                        PP = practical piano                 |            |           |       FT        |\n");
	printf("                        D = duolingo                         |            |           |       D         |\n");
	...
	printf("                        Tuesday: wake up 5:30 sleep 9:15        Saturday: wake up 5:30 sleep 9:15        \n");
	printf("                        Wednesday: wake up 5:30 sleep 9:15      Sunday: wake up 5:30 sleep 9:15          \n");
