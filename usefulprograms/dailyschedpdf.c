...
int main(int argv, char *argc){
	...
	printf("|________\u54e1\u54e1____________DAILY_SCHEDULE___________wake_up_5:20-6:00_sleep_8:10-9:20___________\u54e1\u54e1________|\n");
	...
	printf("|          |            |            |            |          |            |           |     D/B/program   |\n");
	printf("|    Read  |Smart books |    SQL     |     JS     |  C++/SQL |     D      |  Java     |        PA         |\n");
	...
	printf("|__________|____________|____________|____________|__________|____________|___________|___________________|\n");
	printf("|     D    |JavaScript/C|Smart books |     PT     |    D     |  Read      |  ft       |  _     PT         |\n");
	...
	printf("                        PT = piano theory                    |  ft        | PP        | |  C/JS/HTML *2   |\n");
